...
本项目使用现代化的 GitHub Actions 工作流，基于 **Poetry** 依赖管理，支持 Python 3.10-3.13，包含完整的 CI/CD 流程。

## 📋 工作流概览

### 🧪 CI Tests (`.github/workflows/ci.yml`)
- **触发条件**: `main` 和 `develop` 分支的推送/PR
- **测试矩阵**: Python 3.10, 3.11, 3.12, 3.13 × Ubuntu/Windows/macOS
- **功能**:
  - 📦 使用 Poetry 管理依赖
  - 🎨 代码格式检查 (Black)
  - 📚 导入排序检查 (isort)
